...
export function useArticleDraft(userId:number,postId?:string){
 ...
 return {serverCopy,inspect,adopt,draft,form,update,status,error,recovery,resolve,busy,localAvailable,save,action,dirty,ready:!loading.current,blocked:blocked.current};
}
